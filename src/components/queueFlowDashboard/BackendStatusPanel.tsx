...
export default function BackendStatusPanel({
  ...
  return (
    <Panel className="p-5 border border-zinc-600/80 bg-[#212833] shadow-lg shadow-black/25 rounded-sm transition hover:border-zinc-500">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between rounded-md border border-zinc-600/60 bg-[#283140] px-3.5 py-3 text-sm shadow-sm">
          <span className="inline-flex items-center gap-2.5 text-zinc-300 font-medium">
        ...
        <div className="flex items-center justify-between rounded-md border border-zinc-600/60 bg-[#283140] px-3.5 py-3 text-sm shadow-sm">
          <span className="text-zinc-300 font-medium">Checked</span>
          <span className="font-semibold text-zinc-100 font-mono text-xs">
